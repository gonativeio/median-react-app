...
const Home: React.FC<Props> = ({ className }) => (
  ...
  >
    ...
    <g id="SVGRepo_iconCarrier">
      ...
      ></path>
      <g>
        <path d="M256.158,40.379L64.314,224.23c-0.032,11.431,9.209,20.727,20.647,20.759 c5.508,0.016,10.791-2.166,14.684-6.051L201.962,137.82c30.056-29.712,78.416-29.712,108.472,0l88.728,87.929 c15.867,15.699,24.812,37.074,24.86,59.392v186.888c0,8.833-7.154,15.987-15.987,15.987l0,0c-13.245,0-23.98,10.735-23.98,23.981 h47.961c8.833,0,15.987-7.154,15.987-15.987V224.23L256.158,40.379z"></path>
        <rect
          x="176.255"
          y="304.149"
          fill="#F6B545"
      ...
      <rect
        ...
        height="191.844"
      ></rect>
      <circle fill="#50BEE8" cx="256.19" cy="200.233" r="31.974"></circle>
      <path
        fill="#92582B"
      ...
      ></path>
      <circle fill="#CAD1D8" cx="296.157" cy="424.051" r="7.994"></circle>
    </g>
  </svg>
);
